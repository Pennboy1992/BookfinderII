  ...
  render() {
    if (this.state.noResults) {
      return (
        <div>
          <Jumbotron>
            <h1 className="display-4">Let's Find You Something to Read!</h1>
            <p className="lead">Get Searching!</p>
            <hr className="my-4" />
            <p className="lead">
    ...
    return (
      <div>
        <Jumbotron>
          <h1 className="display-4">We Found Something You Might Like!</h1>
          <p className="lead">Now Save the One's You Like!</p>
          <hr className="my-4" />
          <p className="lead">
            <Link className="btn btn-default btn-lg" to="/" role="button">New Search</Link>
            <Link className="btn btn-default btn-lg" to="/saved" role="button">Saved Books</Link>
